...
// ✅ static prevents duplicate definition
static const char* ssid     = "Home 2.4G/5G";
static const char* password = "Nurina*1";

inline void setupOTA() {  // ✅ inline prevents duplicate function definition
  WiFi.mode(WIFI_STA);
